...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $table_content .= "<tr><th scope='row'>" . $counter . "</th><td>" . $row['kode'] . "</td><td>" . $row['nama_brg'] . "</td><td>" . $row['satuan'] . "</td><td>" . $row['jumlah'] . "</td><td>" . $row['tgl_beli'] . "</td><td>" . $row['harga'] . "</td><td><button type='button' class='btn btn-primary' onclick='openEditModal(" . $row['id'] . ")'>Edit</button> <button type='button' class='btn btn-danger' onclick='openRemoveModal(" . $row['id'] . ")'>Remove</button></td></tr>";
